package com.example.admin.favoritepet;
...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener,View.OnClickListener {
    ...
    TextView textQuest;
     RadioGroup rg;
    RadioButton radiosichu,radiorabbit,radiocat;
    Button butOk;
    ImageView imgvPet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radiosichu=(RadioButton) findViewById(R.id.radio_dog);
    ...
    public void onClick(View view) {
        switch (rg.getCheckedRadioButtonId()){
            case R.id.radio_dog:
                imgvPet.setImageResource(R.drawable.sichu);
                break;
            case R.id.radio_cat:
            ...
            case R.id.radio_rabbit:
                ...
                break;
            default:
                Toast.makeText(this,"라디오버튼이 하나도 선택이 안되었네요!",Toast.LENGTH_SHORT).show();
        }
    }
}
